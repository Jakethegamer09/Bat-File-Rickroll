The .bat file when executed opens a link to an autoplay rickroll 



the .vbs file opens a popup window that says "boo" and it does not matter if you click ok, or the X to close it, it will continue to popup.
